...
(function (global) {
  ...
  const MESSAGES = {
    zh: {
      ...
      'badge.tagFilter': '标签：',
      'badge.authorFilter': '作者：',
      'badge.platformFilter': '平台：',
      'clearFilter': '清除筛选',
      ...
      'btn.saved': '已保存',
      'btn.clearResult': '清除',
      'confirm.clearResult': '确定清除本次解析结果？清除后需重新解析。',
    ...
    en: {
      ...
      'badge.tagFilter': 'Tag: ',
      'badge.authorFilter': 'Author: ',
      'badge.platformFilter': 'Platform: ',
      ...
      'btn.saving': 'Saving…',
      'btn.saved': 'Saved',
      'btn.clearResult': 'Discard',
      'confirm.clearResult': 'Discard this unsaved parse result? You will need to parse again.',
